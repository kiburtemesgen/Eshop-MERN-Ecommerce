...
import { productDetailAction, updateProduct } from "../../actions/productAction";
import { UPDATE_PRODUCT_CLEAR } from "../../constants/productConstants";
...
const EditProduct = () => {
  ...
  }, [dispatch, navigate, productId, product, updated, loading]);
